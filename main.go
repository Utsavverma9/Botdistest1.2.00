...
/* Setup
  ...
  Edit: replit has handed over maintenance to me and it appears that .env files are no longer a thing, please click on the lock symbol to the left and add a key named "token", the value being your Discord Bot Token
*/
import (
    "fmt"
    "os"
